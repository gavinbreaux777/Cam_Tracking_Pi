...
class ImageProcessor(threading.Thread):
    def __init__(self, owner):
        ...
        self.owner: ProcessOutput = owner
        self.start()
    ...
    def run(self):
        ...
        while not self.terminated:
            ...
            try:
                ...
                print("ImageProcessorRunInstance")
            except queue.Empty:
                pass
            else:
                stream.seek(0)
...
class ProcessOutput(object):
    def __init__(self, threads):
        ...
        self.incoming: queue.Queue = queue.Queue(threads)
        self.outgoing: queue.Queue = queue.Queue(threads)
